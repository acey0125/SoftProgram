...
<html>
  <head>
	...
	<body>
		<form name="fom" id="fom" method="post" action="servlet/AdminServlet?method=teaChange">
										...
										<fieldset style="height:100%;">
											...
											<table border="0" cellpadding="2" cellspacing="1" style="width:100%">
												<tr>
													<td>教师编号:</td>
													<td>
														<input name="tno" type="text" class="text" style="width:154px" value="${tea.tno }" />${msg }
													</td>
												</tr>
												<tr>
													<td>教师名称:</td>
												...
												<tr>
													<td>教师密码:</td>
													<td>
														<input class="text" type="password" name="pwd" style="width:154px" value="${tea.pwd }" />
													</td>
												</tr>
												...
												<tr>
													<td>联系方式:</td>
													<td>
														<input class="text" name='phone' style="width:154px" value="${tea.phone }" />
													</td>
												</tr>
												...
												<tr>
													<td>入职时间:</td>
													<td>
														<input class="text" name='hiredate' style="width:154px" value="${tea.hiredate }"  onfocus="WdatePicker()"/>
													</td>
												</tr>
