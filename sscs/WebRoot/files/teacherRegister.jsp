...
<html>
  <head>
	...
	<body>
			...
			<form name="fom" id="fom" method="post" action="servlet/AdminServlet?method=teaRegister">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0" class="CContent">
					<tr>
						<th class="tablestyle_title">教师信息录入   ${msg }</th>
					</tr>
					<tr>
						<td class="CPanel">
										...
										<fieldset style="height:100%;">
											<legend>教师信息</legend>
												...
												<tr>
													<td>教师编号:</td>
													<td>
														<input class="text" type="text" name="tno" style="width:154px" value="" />
													</td>
												</tr>
												<tr>
													<td>教师名称:</td>
												...
												<tr>
													<td>入职时间:</td>
													<td>
														<input class="text" name='hiredate' style="width:154px" value=""  onfocus="WdatePicker()"/>
													</td>
												</tr>
												<tr>
													<td valign="top">描述:</td>
